...
/***/ function(module, exports, __webpack_require__) {
	...
	var _studentReducer = __webpack_require__(191);
	...
	var reducers = (0, _redux.combineReducers)({
	    studentState: _studentReducer2.default
	});
...
/***/ function(module, exports) {
	...
	// Students
	var CREATE_STUDENT_SUCCESS = exports.CREATE_STUDENT_SUCCESS = 'CREATE_STUDENT_SUCCESS';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _studentIndexContainer = __webpack_require__(252);
	
	var _studentIndexContainer2 = _interopRequireDefault(_studentIndexContainer);
	
	var _studentCreateContainer = __webpack_require__(274);
	
	var _studentCreateContainer2 = _interopRequireDefault(_studentCreateContainer);
	...
	exports.default = _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            _reactRouter.Route,
	            { path: 'eleves' },
	            _react2.default.createElement(_reactRouter.IndexRoute, { component: _studentIndexContainer2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'ajouter', component: _studentCreateContainer2.default })
	        )
	    )
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibUseQueries = __webpack_require__(212);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _studentList = __webpack_require__(253);
	
	var _studentList2 = _interopRequireDefault(_studentList);
	
	var _studentApi = __webpack_require__(255);
	
	var studentApi = _interopRequireWildcard(_studentApi);
	...
	var StudentIndexContainer = function (_React$Component) {
	    _inherits(StudentIndexContainer, _React$Component);
	
	    function StudentIndexContainer() {
	        _classCallCheck(this, StudentIndexContainer);
	
	        return _possibleConstructorReturn(this, (StudentIndexContainer.__proto__ || Object.getPrototypeOf(StudentIndexContainer)).apply(this, arguments));
	    }
	
	    _createClass(StudentIndexContainer, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _reactRouter.Link,
	                        { className: 'button', to: '/eleves/ajouter' },
	                        'Ajouter un \xE9v\xE8ve'
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'wrapper' },
	                    _react2.default.createElement(_studentList2.default, { students: this.props.students, deleteStudent: studentApi.deleteUser })
	                )
	            );
	        }
	    }]);
	
	    return StudentIndexContainer;
	}(_react2.default.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(StudentIndexContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _student = __webpack_require__(254);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                this.props.students.map(function (student) {
	                    return _react2.default.createElement(_student2.default, { key: student.id, datas: student });
	                })
	            );
	        }
	    }]);
		...
		_createClass(Student, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement("div", { className: "action" })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _studentActions = __webpack_require__(273);
	...
	function createStudent(student) {
	    ...
	    return _axios2.default.post('http://localhost:3001/students', student).then(function (response) {
	        _store2.default.dispatch((0, _studentActions.createStudentSuccess)(student));
	        return response;
	    }, function (error) {});
	}
	...
	function getStudents() {
	    ...
	    return _axios2.default.get('http://localhost:3001/students').then(function (response) {
	        _store2.default.dispatch((0, _studentActions.getStudentsSuccess)(response.data));
	        return response;
	    }, function (error) {
	        console.log(error);
	    });
	...
	function searchUsers() {
	    ...
	    return _axios2.default.get('http://localhost:3001/users?q=' + query).then(function (response) {
	        _store2.default.dispatch(getUsersSuccess(response.data));
	        return response;
	    });
	}
	...
	function deleteUser(userId) {
	    return _axios2.default.delete('http://localhost:3001/users/' + userId).then(function (response) {
	        _store2.default.dispatch((0, _studentActions.deleteUserSuccess)(userId));
	        return response;
	    });
	}
	...
	function getProfile(userId) {
	    ...
	    return _axios2.default.get('http://localhost:3001/users/' + userId).then(function (response) {
	        ...
	        return Promise.all([_axios2.default.get('https://api.github.com/users/' + user.github), _axios2.default.get('https://api.github.com/users/' + user.github + '/repos')]).then(function (results) {
	            ...
	            _store2.default.dispatch((0, _studentActions.userProfileSuccess)(profile));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = window.btoa || __webpack_require__(266);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.createStudentSuccess = createStudentSuccess;
	exports.getStudentsSuccess = getStudentsSuccess;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _studentForm = __webpack_require__(275);
	...
	var StudentNewContainer = function (_React$Component) {
		_inherits(StudentNewContainer, _React$Component);
	
		function StudentNewContainer() {
			_classCallCheck(this, StudentNewContainer);
	
			return _possibleConstructorReturn(this, (StudentNewContainer.__proto__ || Object.getPrototypeOf(StudentNewContainer)).apply(this, arguments));
		}
	
		_createClass(StudentNewContainer, [{
			key: 'create',
			...
			value: function render() {
				...
				if (this.props.student) {
					msg = _react2.default.createElement(_Alert2.default, { msg: "yeah l'étudient " + this.props.student.name.first + " " + this.props.student.name.last + " à bien été ajouté", status: 'success' });
					//msg = <Alert msg={ "yeah l'étudient  à bien été ajouté" } status="success" />;
				}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ id: 'actions' },
						'Ajouter un \xE9l\xE8ve'
					),
					_react2.default.createElement(
						'div',
						{ className: 'wrapper' },
						msg,
						_react2.default.createElement(_studentForm2.default, { create: this.create, cancel: this.cancel })
					)
				);
			}
		}]);
	
		return StudentNewContainer;
	}(_react2.default.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(StudentNewContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StudentForm = function (_React$Component) {
		_inherits(StudentForm, _React$Component);
	
		function StudentForm() {
			_classCallCheck(this, StudentForm);
	
			return _possibleConstructorReturn(this, (StudentForm.__proto__ || Object.getPrototypeOf(StudentForm)).apply(this, arguments));
		}
		...
		_createClass(StudentForm, [{
			...
			value: function render() {
				...
				var bntCancel = '';
				if (this.props.cancel) bntCancel = _react2.default.createElement(
					'a',
					{ className: 'button', onClick: this.props.cancel },
					'Annuler'
				);
	
				return _react2.default.createElement(
					'form',
					{ className: 'form', onSubmit: this.submitStudent.bind(this) },
					_react2.default.createElement(
						'div',
						{ className: 'item-form item-text' },
						_react2.default.createElement('input', { type: 'text', ref: 'first', placeholder: 'Nom' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'item-form item-text' },
						_react2.default.createElement('input', { type: 'text', ref: 'last', placeholder: 'Pr\xE9nom' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'item-form' },
